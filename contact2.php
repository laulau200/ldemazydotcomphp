...
<div id="main">
      ...
      <ollect the nav links, forms, and other content for toggling -->
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <div class="nav navbar-nav">
        ...
        <article>
            ...
            <form action="mail.php" class="p-5 bg-dark">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email" name="email" placeholder="monadresse@fai.com" required>
                  </div>
                  <div class="form-group">
